...
export const getNextCustomId = (menu) => {
  ...
  const lastCustomIdNumber = customMenuItemIdList[customMenuItemIdList.length - 1];
...
export const getNextDefaultId = (menu) => {
  ...
  const lastDefaultIdNumber = defaultMenuItemIdList[defaultMenuItemIdList.length - 1];
